...
<form method="POST" action="/update_add1/{{$data->id}}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
      ...
      <input type="time" class="form-control" id="timestart" placeholder="Time Start" name="timestart" value="{{$data->time_start}}">
    </div>

    <div class="form-group">
      <label for="timeend">Time End</label>
      <input type="time" class="form-control" id="timeend" placeholder="Time End" name="timeend" value="{{$data->time_end}}">
    </div>

    <div class="form-group">
      <label for="datestart">Date Start</label>
      <input type="date" class="form-control" id="datestart" placeholder="Date Start" name="datestart" value="{{$data->date_start}}">
    </div>

    <div class="form-group">
      <label for="dateend">Date End</label>
      <input type="date" class="form-control" id="dateend" placeholder="Date End" name="dateend" value="{{$data->date_end}}">
    </div>
    ...
    <img src="/ads/{{$data->image}}" alt="not found"/>

    <div class="form-group">
      
      <input type="submit" class="form-control" value="Add Post">
    </div>
</form>
@else
<form method="POST" action="/update_add1/{{$data->id}}">
    @csrf
