...
<p>{{$d->address}}<p>
<p>{{$d->city}}<p>
<p><a href="/update_add/{{$d->id}}"> Update</a></p>
<p><a href="/delete_add/{{$d->id}}"> Delete</a></p>
        ...
        @foreach($data as $d)
          ...
          <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="box">
              ...
              <h4 style="font-style: italic;">{{$d->title}}</h4>
              <p class="para">{{$d->description}}</p>
              <p class="para">{{$d->address}}</p>
              <p class="para">{{$d->city}}</p>
              <a href="/update_add/{{$d->id}}" class="btn btn-primary btn-sm"> Update</a>
              <a href="/delete_add/{{$d->id}}" class="btn btn-danger btn-sm"> Delete</a>
            </div>
          </div>
        @endforeach
