...
@endauth      
  ...
  <div class="" style="display:grid;place-items:center;margin-top:5px;margin-bottom:5px;height:auto;">
  <div class="w-50" style="border:1px solid grey;padding:20px;border-radius:20px;">
<form method="POST" action="/abc1" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
      ...
      <input type="time" class="form-control" id="timestart" placeholder="Time Start" name="timestart">
    </div>

    <div class="form-group">
      <label for="timeend">Time End</label>
      <input type="time" class="form-control" id="timeend" placeholder="Time End" name="timeend">
    </div>

    <div class="form-group">
      <label for="datestart">Date Start</label>
      <input type="date" class="form-control" id="datestart" placeholder="Date Start" name="datestart">
    </div>

    <div class="form-group">
      <label for="dateend">Date End</label>
      <input type="date" class="form-control" id="dateend" placeholder="Date End" name="dateend">
    </div>
    ...
    <div class="form-group">
      ...
      <input type="submit" class="form-control btn-success w-25 mt-3" value="Post Ad">
    </div>
</form>
</div>
</div>
